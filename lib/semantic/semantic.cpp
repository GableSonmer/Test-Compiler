...
int TESTparse() {
    ...
    switch (es) {
        ...
        case 10:
            ...
            break;
        case 1:
            printf("ERROR(%d行,%d列): \"%s\"前面缺少{\n", wrow, wcol, token1);
            break;
        case 2:
            printf("ERROR(%d行,%d列): \"%s\"前面缺少}\n", wrow, wcol, token1);
            break;
        case 3:
            printf("ERROR(%d行,%d列): \"%s\"前面缺少标识符\n", wrow, wcol, token1);
            break;
        case 4:
            printf("ERROR(%d行,%d列): \"%s\"前面缺少分号\n", wrow, wcol, token1);
            break;
        case 5:
            printf("ERROR(%d行,%d列): \"%s\"前面缺少(\n", wrow, wcol, token1);
            break;
        case 6:
            ...
            break;
        case 7:
            printf("ERROR(%d行,%d列): \"%s\"前面缺少操作数\n", wrow, wcol, token1);
            break;
        case 12:
            printf("ERROR(%d行,%d列): \"%s\"前面缺少while\n", wrow, wcol, token1);
            break;
        case 21:
            printf("ERROR(%d行,%d列): 符号表溢出\n", wrow, wcol);
            break;
        case 22:
            printf("ERROR(%d行,%d列): 变量\"%s\"重复定义\n", wrow, wcol, token1);
            break;
        case 23:
            printf("ERROR(%d行,%d列): 变量\"%s\"未声明\n", wrow, wcol, token1);
            break;
        case 25:
            printf("ERROR(%d行,%d列): \"%s\"已超出程序末尾\n", wrow, wcol, token1);
            break;
        case 26:
            printf("ERROR(%d行,%d列): else没有匹配的if\n", wrow, wcol);
            break;
        case 27:
            printf("ERROR(%d行,%d列): 错误的声明语句\n", wrow, wcol);
            break;
        case 28:
            printf("ERROR(%d行,%d列): 未知错误(%s, %s)\n", wrow, wcol, token1, token);
            break;
    }
    fclose(fin);
    fclose(fout);
